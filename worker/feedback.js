...
const 預設文案 = {
  ...
  邀請說明: [
    "有些事情，如果沒有記下來，就真的過去了。",
    "這些年神在我們中間做了很多事——有人在難處裡被扶了一把，有人等了很久才看見帶領，有人只是某個平常的早上，忽然讀懂了一句以前讀過很多次的經文。當下都很真實，可是日子一過就慢慢淡了，再過幾年，連自己都想不太起來。",
    "教會想做的其實很單純：把這些事，一件一件記下來。你寫回來，教會就有了紀錄；將來的週年刊、見證分享，才有機會來邀稿、邀請你分享。沒有這份紀錄，這些事就只能靠誰剛好想起誰。",
    "但這封信不回也沒關係，真的。放著就放著——只要你自己心裡沒有忘記神在你身上做過的事，那就夠了。記得的人是你，不是這個網頁。",
    "所以不用有壓力。寫多寫少都好，完整或零散都好。就算最後沒有用在任何地方，這也是一個機會，讓你自己把神在你身上的恩典重新梳理一遍。",
    "我們知道要把心裡的事寫出來並不容易，這份工作我們也做得不夠好。真的很謝謝你願意分享。",
    "願神帶領我們每一個人。",
  ].join("\n\n"),
